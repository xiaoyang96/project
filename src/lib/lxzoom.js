...
LxZoom.prototype = {
	init(){
		...
		// bigContainer.style.left = 380 + 'px';
		// bigContainer.style.top = 0 + 'px';
		...
		bigContainer.style.left = (left-30)+ 'px';
		bigContainer.style.top = (top-30) + 'px';
		...
		smallContainer.onmousemove = e=>{
			var left =  e.pageX - zoom.offsetWidth/2 - smallContainer.offsetLeft;
			var top = e.pageY - zoom.offsetHeight/2 - smallContainer.offsetTop;
